...
// UserInfoRow component defined OUTSIDE the parent component to prevent unmounting and focus loss on rerender
...
const UserPage: React.FC = () => {
    ...
    // State for user profile data, containing all editable fields
    ...
    const handlePasswordSubmit = (e: React.FormEvent) => {
        ...
        // In a real application, there would be an API call here to change the password
