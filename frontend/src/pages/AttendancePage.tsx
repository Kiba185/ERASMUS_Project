...
const SUBJECTS = ['Maths', 'Physics', 'Chemistry', 'Biology', 'History', 'Geography'] as const;
...
const STUDENTS: Student[] = [
  ...
  },
  {
    ...
    name: 'Filip Marek',
    className: '4.B',
    attendance: { Maths: 'present', Chemistry: 'present', History: 'present' },
  },
  {
    id: 'mark-johnson',
    name: 'Mark Johnson',
...
const AttendancePage = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-palette-pine">Today's Attendance - {new Date().toLocaleDateString()}</h1>
        <p className="mt-2 text-sm text-palette-moss">
          Filter by class and subject to check who attended each lesson.
        </p>
      </div>
