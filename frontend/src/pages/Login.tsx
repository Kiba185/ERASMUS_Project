      ...
      <div className="bg-white p-8 rounded-xl shadow-lg border-t-4 border-t-green-500 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button 
            type="submit"
            disabled={loading}
            className="w-full py-3 px-4 bg-green-600 text-white font-bold rounded-lg transition shadow-md mt-2 flex items-center justify-center gap-2 hover:bg-green-700 disabled:bg-green-800 disabled:cursor-not-allowed"
          >
            {loading ? (
              <>
