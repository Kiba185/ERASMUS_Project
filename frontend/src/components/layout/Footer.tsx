...
const Footer: React.FC = () => {
    ...
    return (
            <div>
                <footer className="h-16 w-full z-5 bg-palette-mist border-t border-palette-lichen/45 px-3 py-3 sm:px-6 lg:px-8 flex min-h-16 items-center justify-between gap-3">
