...
// @ts-nocheck 
/*
 * This file exports the `GradeColumn` model and its related types.
 *
...
export type GetGradeColumnAggregateType<T extends GradeColumnAggregateArgs> = {
      [P in keyof T & keyof AggregateGradeColumn]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateGradeColumn[P]>
    : Prisma.GetScalarType<T[P], AggregateGradeColumn[P]>
}
...
export type GetGradeColumnGroupByPayload<T extends GradeColumnGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<GradeColumnGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof GradeColumnGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], GradeColumnGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], GradeColumnGroupByOutputType[P]>
      }
    >
  >
...
export type GradeColumnCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<GradeColumnFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface GradeColumnDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['GradeColumn'], meta: { name: 'GradeColumn' } }
  /**
   ...
   * })
  **/
  count<T extends GradeColumnCountArgs>(
    args?: Prisma.Subset<T, GradeColumnCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], GradeColumnCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends GradeColumnGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, GradeColumnGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetGradeColumnGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
